...
class TestJWS:
    ...
    def test_multiple_keys(token: str) -> None:
        ...
        try:
            ...
            def raise_exception(self, msg, sig) -> bool:
    ...
    def test_invalid_algorithm(self, token: str) -> None:
        with pytest.raises(JWSError):
            jws.verify(token, "secret", [None])

    def test_not_enough_segments(self) -> None:
        token = "eyJhIjoiYiJ9.jiMyrsmD8AoHWeQgmxZ5yq8z0lXS67_QGs52AzC8Ru8"
        with pytest.raises(JWSError):
            jws.verify(token, "secret", ["HS256"])

    def test_header_invalid_padding(self) -> None:
...
class TestJWK:
    def test_jwk(self, payload) -> None:
        key_data = "key"
...
class TestGetKeys:
    ...
    def test_RFC7517_string(self) -> None:
        key = '{"keys": [{}, {}]}'
        assert jws._get_keys(key) == [{}, {}]

    def test_RFC7517_jwk(self) -> None:
        key = {"kty": "hsa", "k": "secret", "alg": "HS256", "use": "sig"}
        assert (key,) == jws._get_keys(key)

    def test_RFC7517_mapping(self) -> None:
        key = {"keys": [{}, {}]}
        assert jws._get_keys(key) == [{}, {}]
...
class TestRSA:
    def test_jwk_set(self, jwk_set) -> None:
    ...
    def test_RSA384(self, payload) -> None:
    ...
    def test_RSA512(self, payload) -> None:
    ...
    def test_private_verify_raises_warning(self, payload) -> None:
...
class TestEC:
    def test_EC256(self, payload) -> None:
    ...
    def test_EC384(self, payload) -> None:
    ...
    def test_EC512(self, payload) -> None:
